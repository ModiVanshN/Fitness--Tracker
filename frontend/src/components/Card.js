      ...
      <div className="parent">
        <div className="card">
          ...
          <div className="content">
            <span className="title">Fitness Tracker_01</span>
            <span className="text">Push yourself because no one else is going to do it for you.</span>
          </div>
...
const StyledWrapper = styled.div`
  ...
  .card {
    height: 100%;
    border-radius: 50px;
    background: linear-gradient(135deg, rgb(0, 119, 255) 0%, rgb(8, 197, 226) 100%);
    transition: all 0.5s ease-in-out;
    transform-style: preserve-3d;
    box-shadow: rgba(5, 48, 71, 0) 40px 50px 25px -40px, rgba(5, 49, 71, 0.2) 0px 25px 25px -5px;
  }
  ...
  .bottom .social-buttons-container .social-button {
    ...
    box-shadow: rgba(5, 48, 71, 0.5) 0px 7px 5px -5px;
  }
  ...
  .parent:hover .card {
    ...
    box-shadow: rgba(8, 5, 71, 0.3) 30px 50px 25px -40px, rgba(5, 71, 17, 0.1) 0px 25px 30px 0px;
  }
